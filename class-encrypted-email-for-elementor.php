 ...
 *
 * The init class that runs the Encrypted Email For Elementor plugin.
 ...
 */
final class Encrypted_Email_For_Elementor {
	...
	public function i18n() {
		load_plugin_textdomain( ENCRYPTED_EMAIL_FOR_ELEMENTOR_TD );
	}
...
// Instantiate
new Encrypted_Email_For_Elementor();
